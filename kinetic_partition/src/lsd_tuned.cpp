 ...
 */
double * lsd_t_scale_region( int * n_out,
 ...
 */
double * lsd_t_scale(int * n_out, double * img, int X, int Y, double scale)
{
  return lsd_t_scale_region(n_out,img,X,Y,scale,NULL,NULL,NULL);
}

/*----------------------------------------------------------------------------*/
/** LSD Simple Interface.
 */
double * lsd_t(int * n_out, double * img, int X, int Y)
{
  /* LSD parameters */
  double scale = 0.8;       /* Scale the image by Gaussian filter to 'scale'. */

  return lsd_t_scale(n_out,img,X,Y,scale);
}
/*----------------------------------------------------------------------------*/
